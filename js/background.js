...
export function initBackground() {
    ...
    const blobs = [
        { bx: 0.20, by: 0.30, r: 80,  speed: 0.35, phase: 0    },
        { bx: 0.75, by: 0.20, r: 70,  speed: 0.55, phase: 1.4  },
        { bx: 0.50, by: 0.65, r: 60,  speed: 0.25, phase: 2.8  },
        { bx: 0.15, by: 0.80, r: 50,  speed: 0.45, phase: 0.7  },
        { bx: 0.85, by: 0.75, r: 65,  speed: 0.30, phase: 2.1  },
    ];
